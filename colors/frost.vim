...
" Colors {{{
let s:col            = {}
let s:col.lemon      = ['#ffff00', 220]
let s:col.special    = ['#BFC5BF', 215]
let s:col.preproc    = ['#d1d1d1', 188]
let s:col.function   = ['#d1d1d1', 188]
let s:col.foreground = ['#d1d1d1', 188]
let s:col.fg_alt     = ['#d1d1d1', 188]
...
let s:col.comment    = ['#ffb354', 215]
let s:col.selection  = ['#2D3032', 238]
let s:col.string     = ['#37ad82', 72]
let s:col.type       = ['#37ad82', 72]
let s:col.constant   = ['#d1d1d1', 215]
